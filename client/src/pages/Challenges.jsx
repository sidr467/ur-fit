...
import { Button, Typography, Box, Tabs, Tab, CircularProgress, Paper } from '@mui/material';
...
const Challenges = () => {
  ...
  const isJoined = (challengeId) => joinedChallenges.some(c => c._id === challengeId);
                ...
                allChallenges.map(challenge => (
                  <Paper key={challenge._id} sx={{ p: 2, mb: 2 }}>
                    ...
                    {isJoined(challenge._id) ? (
                      <Button disabled sx={{ mt: 1 }}>Joined</Button>
                    ) : (
                      <Button sx={{ mt: 1 }} variant="contained" onClick={() => handleJoin(challenge._id)}>
                        Join
                      </Button>
                    )}
                  </Paper>
